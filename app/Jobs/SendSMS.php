...
class SendSMS implements ShouldQueue
{
    ...
    public function maliSms($type,$mobile, $text,$template){
        $client = new Client();
        $username="";
        $pass="";
        $url="https://rest.payamak-panel.com/api/SendSMS/BaseServiceNumber?bodyId=$template&UserName=$username&PassWord=$pass&to=$mobile&text=$text";
